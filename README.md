# 💠 aidasofialily-cmd | Profile Manifest

> **Status:** Operational  
> **Environment:** [Live Portfolio (GitHub Pages)](https://aidasofialily-cmd.github.io)  
> **Creative Lab:** [CodePen Profile](https://codepen.io/Aida-sofia-Lily)
...
| System Component | Specialization |
| :--- | :--- |
| **Logic Engine** | Cycle-accurate hardware emulation (OCaml) |
| **Backend Services** | Scalable distributed architecture (.NET 9) |
| **Visual Research** | Creative CSS & UI Experiments (CodePen) |
| **Data Integrity** | Strongly typed domain modeling (F# / Rust) |

---

## 📂 DEPLOYED_RESOURCES

### 🌐 [Project Portfolio](https://aidasofialily-cmd.github.io)
*Built with GitHub Pages* The primary hub for my software engineering journey, featuring deep-dives into emulator development and system architecture.
...
<p align="center">
  <a href="https://github.com/aidasofialily-cmd">
   <img src="https://repository-contribution-stats.vercel.app/api?username=aidasofialily-cmd&limit=6&theme=tokyonight&bg_color=0d1117&title_color=34a89d&text_color=70a5fd&icon_color=bf91f3&combine_all_yearly_contributions=true&hide_contributor_rank=false" alt="GitHub Top Repo" />
  </a>
</p>
</details>
